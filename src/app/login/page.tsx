    ...
    <main className="flex min-h-[calc(100vh-140px)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        {error && (
          <div
            role="alert"
            className="mb-5 flex items-center gap-2 rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-300"
          >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              required
              aria-required="true"
              className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white placeholder:text-white/25 transition-colors focus:border-cyan-400/50 focus:bg-white/[0.05] focus:outline-none focus:ring-1 focus:ring-cyan-400/50"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-600 py-3 text-sm font-bold text-white shadow-[0_2px_16px_rgba(0,114,255,0.3)] transition-all hover:shadow-[0_4px_24px_rgba(0,114,255,0.5)] disabled:pointer-events-none disabled:opacity-50"
          >
            {loading ? (
